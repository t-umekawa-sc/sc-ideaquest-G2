...
全ドメインが本サービスを共用する＝ログイン XP（G.6 login・+10/JST日）／投稿 XP+50・投票 XP+5（D）／
チャット XP+5〔日次上限10〕（E）／評価 XP+30・選定 XP+200・評価連動コイン（F）／購入 coin_spend・
魔法解放 sp_spend・実績報酬コイン（G/shop/achievements）。commit は呼び出し側。
"""
